  ...
  return (
    <main className="auth-page">
      <div className="auth-card">
        ...
        <button className="google-button" onClick={() => void handleSubmit({ preventDefault: () => {} } as React.FormEvent)} type="button" disabled={isSubmitting}><span className="google-mark">G</span> Continue with Google</button>
